...
impl super::super::Editing {
    pub fn line_start(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn line_end(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn file_start(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn file_end(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
    ...
    pub fn up(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn down(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn left(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn right(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn prev_word(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
    ...
    pub fn next_word(&mut self, w: usize, h: usize) -> PaneCommand<ViewEvent, Theme, In, Out> {
        let mut dirty = false;
